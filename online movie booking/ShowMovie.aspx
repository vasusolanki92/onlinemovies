<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="ShowMovie.aspx.cs" Inherits="online_movie_booking.ShowMovie" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div>
    <div class="header">
       <center> <asp:Label  ID="lbl" runat="server" /></center>
      <center>  <asp:DataList ID="DataList1" Width="87%"  runat="server" RepeatColumns="4" RepeatDirection="Horizontal" BackColor="#DEBA84" BorderColor="#DEBA84" BorderStyle="None" BorderWidth="1px" CellPadding="3" GridLines="Both" CellSpacing="2" >
          ...
          <ItemTemplate>
             <br />
              ...
              <br />
              <br />
              <asp:Button ID="Button1" runat="server" Height="28px" Text="Book Now" Width="99px" OnClick="Button1_Click" />
          </ItemTemplate>
